...
Dataset Description:
69 samples from Fmr1 KO and WT mice. Each mouse had samples collected from two brain regions (S1 and V1), and the samples were separated into PV and CAMK2A cell types by IP. 
